...
void AGrid::OnTileWasSelected(ATile* NewSelectedTile)
{
	...
	UE_LOG(LogTemp, Warning, TEXT("Selected Tile Address: %d\n"), NewSelectedTile->GetGridAddress());
	GEngine->AddOnScreenDebugMessage(0, 2.0f, FColor::Cyan, FString::Printf(TEXT("Select: %d"), NewSelectedTile->GetGridAddress()));
